...
def chat(ws):
    ...
    while(True):
        ...
        db.fulli.insert({'pos1':msg,'match_no':msg2,'stage':msg3,'date':msg4,'1st_bat_team':msg5,'1st_bat_runs':msg6,'1st_bat_wickets':msg7,'1st_bat_overs':msg8,'1st_bat_results':msg9,'2nd_bat_team':msg10,'2nd_bat_runs':msg11,'2nd_bat_wickets':msg12,'2nd_bat_overs':msg13,'2nd_bat_results':msg14})#updating database
        ws.send(msg+"Z"+"<br/><br/><b>"+msg2+". "+msg3+" - "+msg4+"</b><br/><br/>"+"<img src='"+msg5+".png' width='30px' height='30px' alt='"+msg5+"'> "+msg5+"- "+msg6+"/"+msg7+" ("+msg8+"), "+msg9+"<br/>"+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Vs<br/>"+"<img src='"+msg10+".png' width='30px' height='30px' alt='"+msg10+"'> "+msg10+"- "+msg11+"/"+msg12+" ("+msg13+"), "+msg14)#sending new info
        pos=ws.receive();
        data1=ws.receive();
        db.info.update_one(
        {"pos1":pos},
